...
- **Product owner:** approves the Architect’s artifact and execution contract directly before tasks and implementation.
...
The Architect writes only the assigned architecture or conformance artifact. Its authoring contract is installed at `.toscanini/templates/architecture.md`. Its post-implementation responsibility is conformance, not an additional document-review role.
