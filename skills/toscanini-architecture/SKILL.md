...
When authoring, produce an architecture artifact and conclude with `APPROVED`, `APPROVED_WITH_CONDITIONS`, or `BLOCKED`. When reviewing, use an independent context, inspect evidence directly, and conclude with `APPROVE` or `REQUEST_CHANGES`.
